...
Game.initialize = function () {
    ...
    if (window.location.protocol == 'http:') {
        Game.connect('ws://' + window.location.host + '<%=request.getContextPath()%>/websocket/snake');
    } else {
        Game.connect('wss://' + window.location.host + '<%=request.getContextPath()%>/websocket/snake');
    }
};
